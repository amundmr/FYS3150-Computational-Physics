...
System initialize()
{
    ...
    Planet Mercury("Mercury", 1.65E-7, init_r_mercury, init_v_mercury);
    system.add(Mercury);
    ...
    Planet Venus("Venus", 2.45E-6, init_r_Venus, init_v_Venus);
    system.add(Venus);
    ...
    Planet Earth("Earth", 3E-6, init_r_Earth, init_v_Earth);
    system.add(Earth);
    ...
    Planet Mars("Mars", 3.3E-7, init_r_Mars, init_v_Mars);
    system.add(Mars);
    ...
    Planet Jupiter("Jupiter", 9.5E-4, init_r_Jupiter, init_v_Jupiter);
    system.add(Jupiter);
    ...
    Planet Saturn("Saturn", 2.75E-4, init_r_Saturn, init_v_Saturn);
    system.add(Saturn);
    ...
    Planet Uranus("Uranus", 4.4E-5, init_r_Uranus, init_v_Uranus);
    system.add(Uranus);
    ...
    Planet Neptune("Neptune", 5.15E-5, init_r_Neptune, init_v_Neptune);
    system.add(Neptune);
