...
System initialize()
{
    ...
    std::string name = "Sun";
    Body Sun(name, 1.65E-7, init_r_Sun, init_v_Sun);
    system.add(Sun);
    ...
    name = "Mercury";
    Body Mercury(name, 1.65E-7, init_r_mercury, init_v_mercury);
    system.add(Mercury);
    ...
    name = "Venus";
    Body Venus(name, 2.45E-6, init_r_Venus, init_v_Venus);
    system.add(Venus);
    ...
    name = "Earth";
    Body Earth(name, 3E-6, init_r_Earth, init_v_Earth);
    system.add(Earth);
    ...
    name = "Mars";
    Body Mars(name, 3.3E-7, init_r_Mars, init_v_Mars);
    system.add(Mars);
    ...
    name = "Jupiter";
    Body Jupiter(name, 9.5E-4, init_r_Jupiter, init_v_Jupiter);
    system.add(Jupiter);
    ...
    name = "Saturn";
    Body Saturn(name, 2.75E-4, init_r_Saturn, init_v_Saturn);
    system.add(Saturn);
    ...
    name = "Uranus";
    Body Uranus(name, 4.4E-5, init_r_Uranus, init_v_Uranus);
    system.add(Uranus);
    ...
    name = "Neptune";
    Body Neptune(name, 5.15E-5, init_r_Neptune, init_v_Neptune);
    system.add(Neptune);
