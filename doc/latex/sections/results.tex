...
\begin{figure}[!ht]
  \centering
  \parbox{5cm}{
  \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T1_1.png}
  \caption{Number of accepted spins for 100 000 monte carlo cycles per lattice site$L\times L$ for $T= 1.0(Jk/T)$ ordered}
  \label{fig:accepted_spinnT1}}
  \qquad
  \begin{minipage}{5cm}
    \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T2_1.png}
    \caption{Number of accepted spins for 100 000 monte carlo cycles per lattice site$L\times L$ for $T= 2.4(Jk/T)$ ordered}
...
\begin{figure}[!ht]
  \centering
  \parbox{5cm}{
  \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T1_random_1.png}
  \caption{Number of accepted spins for 100 000 monte carlo cycles per lattice site$L\times L$ for $T= 1.0(Jk/T)$ random}
  \label{fig:accepted_spinnT1_random}}
  \qquad
  \begin{minipage}{5cm}
    \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T2_random_1.png}
    \caption{Number of accepted spins for 100 000 monte carlo cycles per lattice site$L\times L$ for $T= 2.4(Jk/T)$ random}
...
\begin{figure}[!ht]
  \centering
  \parbox{5cm}{
  \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T1_random_zoom.png}
  \caption{Number of accepted spins for 100 000 monte carlo cycles per lattice site$L\times L$ for $T= 1.0(Jk/T)$ random}
  \label{fig:accepted_spinnT1_random_zoom}}
  \qquad
  \begin{minipage}{5cm}
    \includegraphics[width=5cm]{./accepted_spin/accepted_spinn_T2_random_zoom.png}
    \caption{Number of accepted spins for 100 monte carlo cycles per lattice site$L\times L$ for $T= 2.4(Jk/T)$ random}
    \label{fig:accepted_spinnT2_random_zoom}
  \end{minipage}
  \end{figure}
\FloatBarrier

The number of accepted spins behave, as expected, the same way as the energies and magnetisation when increasing the number of Monte Carlo cycles. This is further discussed in \ref{discussion}.
