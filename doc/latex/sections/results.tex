...
\begin{figure}[!h]
  ...
  \caption{Number of accepted spins for $10^5$ MC cycles per lattice size $L\times L$ for ordered initialization at $T= 1.0(Jk/T)$ and $T= 2.4(Jk/T)$ respectively.}
...
\begin{figure}[!h]
  ...
  \caption{Number of accepted spins for $10^5$ MC cycles per lattice size $L\times L$ for random initialization at $T= 1.0(Jk/T)$ and $T= 2.4(Jk/T)$ respectively.}
  \label{fig:results-ProbE_T24}
\end{figure}
\FloatBarrier
...
\begin{figure}[!h]
  ...
  \caption{Number of accepted spins for $100$ MC cycles per lattice size $L\times L$ for random initialization at $T= 1.0(Jk/T)$ and $T= 2.4(Jk/T)$ respectively.}
  \label{fig:results-ProbE_T24}
\end{figure}
\FloatBarrier
