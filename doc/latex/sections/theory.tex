...
This leads to the integral, see below, which will be solved nummericaly with the three different methods mentioned earlier.
...
\subsection{Improved Gauss-Quadrature- Laguerre} \label{sec:improved_GQ}
