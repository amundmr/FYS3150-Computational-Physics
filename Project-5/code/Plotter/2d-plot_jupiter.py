...
with open('../complete_solar-system/output/jupiter/Earth1000.txt', 'r') as f:
    for line in f:
        l = line.split("\t")
        earth_x.append(float(l[0])); earth_y.append(float(l[1])); earth_z.append(float(l[2]))

jupiter_x = []; jupiter_y = []; jupiter_z = []
with open('../complete_solar-system/output/jupiter/Jupiter1000.txt', 'r') as f:
    for line in f:
        l = line.split("\t")
...
sun_x = []; sun_y = []; sun_z = []
with open('../complete_solar-system/output/jupiter/Sun1000.txt', 'r') as f:
    for line in f:
        l = line.split("\t")
